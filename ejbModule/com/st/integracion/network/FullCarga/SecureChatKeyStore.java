 ...
 *          -keystore cert.jks
 * </pre>
 * keytool -v -import -file easycall_cliente.cer -keystore cacerts -storepass changeit -alias easycallCert
 *
...
public class SecureChatKeyStore {
    ...
    public static InputStream fileAsInputStream(){
    	FileInputStream file = null;
    	try{
    		//file =	new FileInputStream("/usr/lib/jvm/java-6-sun-1.6.0.12/jre/lib/security/cacerts");
    				//"/usr/lib/jvm/java-6-sun-1.6.0.12/jre/lib/security/cacerts");
					
    		//file =	new FileInputStream("/usr/java/jdk1.6.0_35/jre/lib/security/cacerts"); //10.10.1.130
    		file =	new FileInputStream("/usr/java/jdk1.6.0_25/jre/lib/security/cacerts"); // 192.168.1.30
    		//file =	new FileInputStream("D:\\security\\cacerts");
    	}catch(Exception e ){
    		return null;
    	}
    	return file;
